#include <cmath>    // M_PI
#include <iomanip>  // std::setprecision e altre robe simili
#include <iostream>
#include <string>
...
int main() {
  ...
  // narrowing effect
  int var = 6.9;  // try with the universal and
  ...
  int ve{int(ce * a)};  // ok posso creare una variabile da constexpr

  // constexpr int  n_ce {ve*8.1234/M_PI};    // error

  (void)ve;  // cast to void, to suppress warning of unused variable (boh)
