...
#include <iostream>
//vogliamo tenere private le age e weight di animal
// perso qualcosa allinizio di questo file: binding + ??
...
class Snake : public Animal {
 ...
 public:
  Snake(const unsigned int a, const double w, const bool b) : Animal{a, w}, dangerous{b} {}
...
struct Python : public NonDangerousSnake {}; //python will appear as a type

using Anaconda = DangerousSnake;  //anaconda won't, its just an alias
