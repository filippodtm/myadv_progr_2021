...
struct Animal {
  ...
  void speak() const noexcept { std::cout << "-- \n"; }
...
void print_animal(const Animal& a) noexcept { //a function that can take the parent can take also the children
...
int main() {
  try {
    ...
    print_animal(s);
    std::cout << std::endl;
    print_animal_template(s);   //comp time
