...
struct Point_s {
  ...
  friend std::ostream& operator<<(std::ostream& os, const Point_s& p) {   
...
//Con FRIEND la funzione non è più MEMBER, ma diventa come una funzione esterna (e quindi NON SI BECCA PIÙ IL PARAMETRO IN PIÙ "this" DC)
 // "friend" gives this function(or operator) access to private data.    è come se fosse una funzione esterna amica
