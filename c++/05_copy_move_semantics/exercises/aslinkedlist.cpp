#include <memory>
#include <algorithm>  //per std::find e altre

//we can have forward iterators, bidirectional iterators, r.a. iterator
// for std::vector there's a difference betw constructor with () or {}
//std::vector<int> v{4, 0} crea lungh 4 tutto di zeri
//NB: con auto non usare {}, meglio =
